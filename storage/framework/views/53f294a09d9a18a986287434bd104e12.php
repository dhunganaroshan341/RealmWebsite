                            ...
                            <div class="card-tools">
                                <form action="" method="get">
                                    <div class="input-group mb-0 mt-0" style="width: 250px;">
                                        <input value="<?php echo e(!empty(Request::get('keyword')) ? Request::get('keyword') : ''); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(!empty($service->image)): ?>
                                                    <img src="<?php echo e(asset($service->image)); ?>" width="50">
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('uploads/placeholder.jpg')); ?>" alt=""
                                                        width="50">
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0);" class="deleteButton"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="#dc3545" class="bi bi-trash" viewBox="0 0 16 16">
                                                        <path
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/joyboy/Documents/RealmWebsite/resources/views/admin/services/list.blade.php ENDPATH**/ ?>