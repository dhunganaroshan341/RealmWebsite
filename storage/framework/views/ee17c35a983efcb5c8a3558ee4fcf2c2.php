...
<script type="text/javascript">
    ...
    $("#createPage").submit(function(event){
        ...
        $.ajax({
            url: '<?php echo e(route("page.save")); ?>',
            type: 'POST',
            dataType: 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\applications\laragon\laragon\www\RealmLaravel10Website\resources\views/admin/pages/create.blade.php ENDPATH**/ ?>