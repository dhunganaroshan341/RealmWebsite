                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="<?php echo e(route('page.create.form')); ?>" class="btn btn-primary">Create</a>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="<?php echo e(asset('uploads/pages/thumb/large/'.$page->image)); ?>" width="50">
                                        <?php else: ?>
                                        <img src="<?php echo e(asset('uploads/placeholder.jpg')); ?>" alt="" width="50">
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e($page->name); ?> &nbsp; <a title="preview" href="<?php echo e(url('static/' . $page->id)); ?>"><i class="fas fa-eye"></i></a></td>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('page.edit',$page->id)); ?>" class="">
                                        ...
                                        &nbsp;
                                        <a href="javascript:void(0);" class="" onclick="deletePage(<?php echo e($page->id); ?>);">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\applications\laragon\laragon\www\RealmLaravel10Website\resources\views/admin/pages/list.blade.php ENDPATH**/ ?>