                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <a href="<?php echo e(route('banner-sliders.create')); ?>" class="btn btn-primary">Create</a>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table">
                                ...
                                <?php if(!empty($bannerSliders)): ?>
                                    <?php $__currentLoopData = $bannerSliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($slider->id); ?></td>
                                    <td>
                                        <?php if(!empty($slider->image)): ?>
                                        <img src="<?php echo e(asset('uploads/banner-sliders/'.$slider->image)); ?>" width="50">
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('banner-sliders.edit', $slider->id)); ?>" class="">
                                        ...
                                        &nbsp;
                                        <a href="javascript:void(0);" class="" onclick="deleteBannerSlider(<?php echo e($slider->id); ?>);">
...
function deleteBannerSlider(id) {
    if (confirm("Are you sure you want to delete this banner slider?")) {
        $.ajax({
            url: '<?php echo e(url("/admin/banner-sliders/delete")); ?>/' + id,
            type: 'POST',
            dataType: 'json',
            data: {},
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\applications\laragon\laragon\www\RealmLaravel10Website\resources\views/admin/banner-slider/list.blade.php ENDPATH**/ ?>