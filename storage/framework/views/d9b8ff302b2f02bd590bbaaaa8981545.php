...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('lobybox/bootstrap/dist/css/bootstrap.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('lobybox/dist/css/lobibox.min.css')); ?>" />
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('blogList')); ?>"
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('faqList')); ?>"
                                class="nav-link <?php echo e(Request::is('admin/faqs*') ? 'active' : ''); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Manage FAQ</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('pageList')); ?>"
                        ...
                        <li class="nav-item <?php echo e(Request::is('admin/banner-sliders*') ? 'menu-open' : ''); ?>">
                            <a href="#"
                                class="nav-link <?php echo e(Request::is('admin/banner-sliders*') ? 'active' : ''); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('banner-sliders.index')); ?>"
                                        class="nav-link <?php echo e(Request::is('admin/banner-sliders*') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Bannerslider</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(url('/admin/page-sections/sliders')); ?>"
                                        class="nav-link <?php echo e(Request::is('admin/page-sections/sliders') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Sliders</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('/admin/page-sections/other')); ?>"
                                        class="nav-link <?php echo e(Request::is('admin/page-sections/other') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Other Sections</p>
                                    </a>
                                </li>
    ...
    <script src="<?php echo e(asset('lobybox/lib/jquery.1.11.min.js')); ?>"></script>
    <script src="<?php echo e(asset('lobybox/dist/js/lobibox.min.js')); ?>"></script>
    <script src="<?php echo e(asset('lobybox/dist/js/messageboxes.min.js')); ?>"></script>
    <script src="<?php echo e(asset('lobybox/dist/js/notifications.min.js')); ?>"></script>
...
<?php /**PATH /home/joyboy/Documents/RealmWebsite/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>