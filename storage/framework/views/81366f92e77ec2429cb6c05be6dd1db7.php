...
<section class="section-4 py-5 text-center">
    ...
    <div class="container">
       <div class="help-container">
            <h1 class="title"><?php echo e($cta->cta_title??'Do you need help?'); ?></h1>
            <p class="card-text mt-3"><?php echo e($cta->cta_description??'Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi ipsum, odit velit exercitationem praesentium error id iusto dolorem expedita nostrum eius atque? Aliquam ab reprehenderit animi sapiente quasi, voluptate dolorum?'); ?></p>
            <a href="<?php echo e($cta->cta_link); ?>" class="btn btn-primary mt-3">Reach Out <i class="fa-solid fa-angle-right"></i></a>
       </div>
    </div>
</section>
