                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('serviceList')); ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Manage Services</p>
                                </a>
                            </li>
							<li class="nav-item">
                                <a href="<?php echo e(route('blogList')); ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Manage Blogs</p>
                                </a>
                            </li>
							<li class="nav-item">
                                <a href="<?php echo e(route('faqList')); ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Manage Faq</p>
                                </a>
                            </li>
							<li class="nav-item">
                                <a href="<?php echo e(route('pageList')); ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Manage Pages</p>
                                </a>
                            </li>
