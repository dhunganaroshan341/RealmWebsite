        ...
        <div class="row">
            <div class="col-md-6 align-items-center d-flex">
                <div class="about-block">
                    <h1 class="title-color">
                        <?php echo e(isset($home_welcome_content['title']) ? $home_welcome_content['title'] : 'Welcome'); ?>

                    </h1>
                    <div class="mt-2 mb-3 text-muted">
                        <?php echo e(isset($home_welcome_content['subtitle']) ? $home_welcome_content['subtitle'] : 'To, Realm Infotech!'); ?>

                    </div>
                    <p>
                        <?php echo e(isset($home_welcome_content['description']) ? $home_welcome_content['description'] :
            ...
            <div class="col-md-6">
                <div class="image-red-background">
                    <img src="<?php echo e(isset($home_welcome_content['image']) ? asset($home_welcome_content['image']) : asset('assets/images/about-us.jpg')); ?>"
                         alt="Welcome Image"
                         class="w-100">
                </div>
            </div>
