...
<?php endif; ?>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" style="background-image: url('<?php echo e(asset('assets/images/banner.jpg')); ?>') ;">
            ...
            <div class="carousel-item " style="background-image: url('<?php echo e(asset('assets/images/banner1.jpg')); ?>') ;">
                <div class="hero-background-overlay"></div>
                <div class="container h-100">
                    <div class="row align-items-center d-flex h-100">
                        <div class="col-md-7">
            ...
            <div class="carousel-item" style="background-image: url('<?php echo e(asset('assets/images/banner24.jpg')); ?>') ;">
                <div class="hero-background-overlay"></div>
