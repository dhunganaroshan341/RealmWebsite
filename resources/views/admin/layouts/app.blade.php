...
<head>
    ...
    {{-- Loby Box Notification --}}
    <link rel="stylesheet" href="{{ asset('lobybox/bootstrap/dist/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('lobybox/dist/css/lobibox.min.css') }}" />
    {{-- Loby Box Notification --}}
    @stack('styles')
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item {{ Request::is('admin/banner-sliders*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ Request::is('admin/banner-sliders*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('/admin/page-sections/sliders') }}"
                                        class="nav-link {{ Request::is('admin/page-sections/sliders') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Sliders</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('/admin/page-sections/other') }}"
                                        class="nav-link {{ Request::is('admin/page-sections/other') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Other Sections</p>
                                    </a>
                                </li>
    ...
    <script src="{{ asset('lobybox/lib/jquery.1.11.min.js') }}"></script>
    <script src="{{ asset('lobybox/dist/js/lobibox.min.js') }}"></script>
    <script src="{{ asset('lobybox/dist/js/messageboxes.min.js') }}"></script>
    <script src="{{ asset('lobybox/dist/js/notifications.min.js') }}"></script>
